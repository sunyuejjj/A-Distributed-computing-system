...
public class ExecutorManager {
    ...
    public void updateExecutorRegister(ExecutorRegister executorRegister) {
        // 将executor传过来的值进行注册
        executorRegisterMap.put(executorRegister.getExecutorUrl(),executorRegister); // url -> executor
        //建立ExecutorUrl和Core数的映射
        executorAvailableCoresMap.put(executorRegister.getExecutorUrl(),executorRegister.getCores()); // url -> cores
    }
